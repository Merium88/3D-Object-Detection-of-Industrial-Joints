...
/////////////////////////////////////////////////////////////////////////Object Detection Module//////////////////////////////////////////////////// 
 ...
 uniform_sampling.setInputCloud (full);
  ...
  pcl::PointCloud<pcl::PointXYZRGBA>::Ptr scene_crop(new pcl::PointCloud<pcl::PointXYZRGBA>);
  scene_ptr = scene;
...
////////////////////////////////////////////////////////////////Resume Object DEtection Code//////////////////////////////////////////////////////////
  ...
  pcl::SHOTEstimationOMP<PointType, NormalType, DescriptorType> descr;
  descr.setRadiusSearch (descr_rad_);
  descr.setInputCloud (scene_keypoints);
  descr.setInputNormals (scene_normals);
  descr.setSearchSurface (scene_crop);
  descr.compute (*scene_descriptors);
...
// REmove NaNs from POintcloud
 ...
 pcl::search::KdTree<pcl::PointXYZRGBA>::Ptr tree (new pcl::search::KdTree<pcl::PointXYZRGBA> ());
  ...
  {    
    ...
    int found_neighs = match_search.nearestKSearch (scene_descriptors->at(i), 2, neigh_indices, neigh_sqr_dists);
